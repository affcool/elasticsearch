# Turimor Elasticsearch

本源码 Fork 自 https://github.com/crcms/elasticsearch
...
```
composer require affcool/elasticsearch
```
...
```
'providers' => [
    Turimor\ElasticSearch\LaravelServiceProvider::class,
]
